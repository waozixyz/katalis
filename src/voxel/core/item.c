...
static const ItemProperties g_item_properties[ITEM_COUNT] = {
    ...
    [ITEM_WOOD_LOG] = {
        ...
        .is_tool = false,
        .durability = 0,
        .atlas_tile_x = 1,  // Use wood rings (cross-section) for recognizable icon
        .atlas_tile_y = 3,
        .tool_type = TOOL_NONE,
        .dig_speed = 1.0f,
    },
    [ITEM_WOOD_PLANKS] = {
        ...
        .is_tool = false,
        .durability = 0,
        .atlas_tile_x = 3,  // Planks texture at (3,3) - different from log rings and stick
        .atlas_tile_y = 3,
        .tool_type = TOOL_NONE,
        .dig_speed = 1.0f,
    },
    ...
    [ITEM_IRON_BLOCK] = {
        ...
        .max_stack_size = 64,
        .is_placeable = true,
        .places_as = BLOCK_IRON_ORE,  // Placeholder
        .is_tool = false,
        .durability = 0,
        .atlas_tile_x = 1,
        .atlas_tile_y = 12,
    ...
    [ITEM_DIAMOND_BLOCK] = {
        ...
        .max_stack_size = 64,
        .is_placeable = true,
        .places_as = BLOCK_DIAMOND_ORE,  // Placeholder
        .is_tool = false,
        .durability = 0,
        .atlas_tile_x = 1,
        .atlas_tile_y = 14,
    ...
    [ITEM_WOOL_WHITE] = {
        ...
        .max_stack_size = 64,
        .is_placeable = true,
        .places_as = BLOCK_LEAVES,  // Placeholder
        .is_tool = false,
        .durability = 0,
        .atlas_tile_x = 0,
        .atlas_tile_y = 30,
